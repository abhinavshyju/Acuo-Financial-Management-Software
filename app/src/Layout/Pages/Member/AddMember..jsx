...
const AddMember = () => {
    ...
    const Submit = async (e) => {
        ...
        try {
            ...
            const confirm = await window.BackendAPI.on('NewMemberCreated');
    ...
    return (
        ...
        <div className="flex mb-8">
            ...
            <MemberSubNAv id="1"/>
            <form onSubmit={Submit}className="container flex flex-col mx-auto space-y-12 mt-10 rounded-md shadow-sm bg-white border pb-5  ">
                <fieldset className="grid grid-cols-4 gap-6 p-6 ">
                    <div className="space-y-2 col-span-full ">
                        <p className="font-bold text-2xl">Add New Member</p>
                        <p className="text-neutral-600">Welcome New Members – Add Them Here</p>
                    </div>
                    <div className="grid grid-cols-6 gap-4 col-span-full ">
                        <div className="col-span-full sm:col-span-3">
                            <label for="firstname" className="text-sm">Name</label>
                            <input id="firstname" type="text" placeholder="Name" className="w-full rounded-md  border-gray-300 text-gray-900" 
                             value={name}
                        ...
                        <div className="col-span-full sm:col-span-3">
                            ...
                            <input id="lastname" type="number" placeholder="Phone number" className="w-full rounded-md  border-gray-300 text-gray-900" 
                            value={phoneno}
                        ...
                        <div className="col-span-full sm:col-span-3">
                            ...
                            <input id="email" type="email" placeholder="Email" className="w-full rounded-md  border-gray-300 text-gray-900" />
                        </div>
                        <div className="col-span-full">
                            <label for="address" className="text-sm">Address</label>
                            <input id="address" type="text" placeholder="" className="w-full rounded-md  border-gray-300 text-gray-900" 
                            value={address}
                        ...
                        <div className="col-span-full sm:col-span-2">
                            ...
                            <input id="city" type="text" placeholder="" className="w-full rounded-md  border-gray-300 text-gray-900" />
                        </div>
                        <div className="col-span-full sm:col-span-2">
